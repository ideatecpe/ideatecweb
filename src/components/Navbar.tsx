    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <button
            onClick={toggleTheme}
            className="p-2.5 rounded-full bg-bg-secondary text-text-primary hover:text-accent transition-all duration-300 border border-bg-secondary"
        ...
        <div className="flex items-center gap-4 md:hidden">
          <button
            onClick={toggleTheme}
            className="p-2 rounded-full bg-bg-secondary text-text-primary border border-bg-secondary"
          >
            {theme === 'light' ? <Moon className="w-5 h-5" /> : <Sun className="w-5 h-5" />}
          </button>
          <button
          ...
          >
            {theme === 'light' && isMobileMenuOpen ? <X /> : isMobileMenuOpen ? <X /> : <Menu />}
          </button>
        </div>
      </div>
