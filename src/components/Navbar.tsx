    ...
    <header ref={headerRef} className="sticky top-0 z-50">
      ...
      <div className="hidden lg:block bg-gray-900 text-gray-300">
        <div className="max-w-7xl mx-auto px-6 py-2 flex justify-between items-center">
          <div className="flex items-center gap-1.5 text-xs">
            ...
            <span>Av. Petit Thouras 1775, Int. 501 — Lince, Lima, Perú</span>
          </div>
          <div className="flex items-center gap-6 text-xs">
            <a href="mailto:info@ideatec.com.pe" className="flex items-center gap-1.5 hover:text-orange-400 transition-colors">
              <Mail className="w-3 h-3" />
              info@ideatec.com.pe
            </a>
            <a href="tel:+51912903330" className="flex items-center gap-1.5 hover:text-orange-400 transition-colors">
      ...
      <nav
        className={`relative border-b transition-all duration-300 ${
          scrolled
            ? 'border-white/10 shadow-[0_4px_20px_rgba(0,0,0,0.1)]'
            : 'bg-[#f8f9fa] border-transparent'
        }`}
        style={scrolled ? { backgroundColor: '#f8f9fa' } : {}}
      >
            ...
            <div className="hidden lg:flex items-center gap-3">
              ...
              <div className="wa-btn-wrap">
                ...
                <a
                  ...
                  className="wa-btn-inner flex items-center gap-2 px-4 py-2 text-sm font-medium text-green-700 hover:text-green-800 transition-colors"
                >
